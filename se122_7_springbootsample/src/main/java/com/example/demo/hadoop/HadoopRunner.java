...
public class HadoopRunner {
    ...
    public static class TokenizerMapper
        ...
        private final static String[] keywords = {"classic", "fiction", "science","adventure"};
    ...
    public static int WordCount() throws Exception {
        ...
        conf.set("mapreduce.cluster.local.dir","/Users/simmucheng/tmp/");
...
// 获取Mapper的数量
        ...
        System.out.println("Mapper数量：" + numMapTasks);
// 获取Reducer的数量
        int numReduceTasks = job.getConfiguration().getInt("mapreduce.job.reduces", 1);
        System.out.println("Reducer数量：" + numReduceTasks);
        FileInputFormat.addInputPath(job, new Path("D:\\bookstore\\demo\\se3353_25_spark_python\\books"));
        FileOutputFormat.setOutputPath(job, new Path("D:\\bookstore\\demo\\se3353_25_spark_python\\hadoopOutput"));
